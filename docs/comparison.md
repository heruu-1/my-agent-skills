...
| **Catalog size** | 40 skills: 25 lifecycle skills plus 15 Heru research, ML, and agent-engineering extensions | ~14 skills, deep on the inner build loop | ~30 skills, grouped into engineering / productivity / in-progress / deprecated |
