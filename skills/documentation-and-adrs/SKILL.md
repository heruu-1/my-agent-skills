...
description: Records architecture decision records (ADRs) and decision documentation. Use when making architectural decisions, choosing between designs, changing public APIs, shipping features, or when you need to record context that future engineers and agents will need to understand the codebase.
---
