...
description: Guides systematic root-cause debugging. Use when tests fail, including when a test passed previously and you need to figure out what broke, builds break, behavior doesn't match expectations, or you encounter any unexpected error. Use when you need a systematic approach to finding and fixing the root cause rather than guessing.
---
